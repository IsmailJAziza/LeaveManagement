...
{
    /// <inheritdoc />
    public partial class ExtendusertableSeedingData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "408aa945-3d84-4421-8342-7269ec64d949", 0, "stamp-admin-user", new DateOnly(1995, 2, 9), "admin@localhost.com", true, "Default", "Admin", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEApoOrRFC1N4RRjDSnWORXV5Glbm6fPpLj3TbDaqqd9IVwWcsAYxA9VjOvynEUf3jg==", null, false, "SECURITYSTAMP", false, "admin@localhost.com" });
